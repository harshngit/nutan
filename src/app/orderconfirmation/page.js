          ...
          <div className="flex-1 max-w-xl bg-gray-100 rounded-xl shadow-md p-6 relative">
            <div className="border-b pb-4 mb-4">
              ...
              <div className="flex justify-between text-sm text-gray-700">
				<span><strong>Date</strong><br />{orderDetails?.createdAt ? new Date(orderDetails.createdAt).toLocaleDateString() : "N/A"}</span>
            ...
            {orderDetails?.invoices?.map((item, index) => (
              <div key={index} className="border-t mt-6 pt-4 space-y-2 text-sm text-gray-700">
