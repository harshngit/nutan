      ...
      <div className="relative z-10 flex flex-col justify-end h-full p-6 lg:p-12">
        ...
        <div className="flex-1 flex items-end">
          <div className="max-w-lg">
            ...
            <button className="bg-white text-black lg:px-8 px-4 lg:py-3 py-2 rounded-lg font-bold md:text-sm text-[10px] tracking-wider hover:bg-gray-100 transition-colors duration-300">
            ENQUIRE NOW
          </button>
          </div>
        </div>
